...
void MainWindow::on_messengeLineEdit_returnPressed()
{
...
{
    m_dbPtr->addChatMessage(m_userName.toStdString(),ui->messengeLineEdit->text().toStdString());
}
...
void MainWindow::on_privateMessageSendButton_clicked()
{
    ...
    if (result == QDialog::Accepted && userListWgt->currentItem()){
        ...
        m_dbPtr->addPrivateMessage(m_userName.toStdString(),
                                   ...
                                   ui->messengeLineEdit->text().toStdString());
    }
